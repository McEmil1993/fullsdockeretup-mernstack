          ...
          {showSearch && (
            <div className="relative w-full sm:w-auto">
              <input
                ...
                className="w-full sm:max-w-[500px] lg:max-w-[600px] pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <svg
