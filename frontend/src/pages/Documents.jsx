...
<body>
  ...
  const handleExportHTML = () => {
    // Convert markdown to HTML using marked (with GFM and IDs)
    const contentHTML = marked(content || '*No content*', {
      gfm: true,
      breaks: true,
      headerIds: true,
...
/* Ensure pre blocks are positioned relative for copy button */
pre {
  position: relative;
}
</style>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="hidden lg:flex flex-1">
          ...
          >
            ...
            {showPreview && (
              <div className="overflow-y-auto overflow-x-hidden bg-white dark:bg-gray-800 h-full">
                {content ? (
